...
export default {
  nomenclaturesUri: {
    ...
    getOtherSynonyms: `${backendBase}/api/nomenclatures/<%id%>/synonyms-other?access_token=<%accessToken%>`,
    ...
    getParentCombinationForUri: `${backendBase}/api/nomenclatures/<%id%>/parent-combination-for?access_token=<%accessToken%>`,
    getTaxonPositionForUri: `${backendBase}/api/nomenclatures/<%id%>/taxon-position-for?access_token=<%accessToken%>`,
