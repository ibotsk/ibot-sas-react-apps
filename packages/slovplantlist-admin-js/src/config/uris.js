...
export default {
  nomenclaturesUri: {
    ...
    getParentalCombinations: `${backendBase}/api/nomenclatures/<%id%>/parental-combinations?access_token=<%accessToken%>`,
    getTaxonPositions: `${backendBase}/api/nomenclatures/<%id%>/taxon-positions?access_token=<%accessToken%>`,
